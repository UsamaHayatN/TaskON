  ...
  const onDragEnd = useCallback(
    (result: DropResult) => {
      ...
      setTasks((prevTasks) => {
        ...
        // If there's no task then
        if (!movedTask) {
          console.log("No task found at index");
          return prevTasks;
        }
        ...
        // If the task moved between the columns, update the position in the source column
